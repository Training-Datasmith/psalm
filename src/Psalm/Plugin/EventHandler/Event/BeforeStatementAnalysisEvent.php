...
final class Before_Statement_Analysis_Event
{
    /**
     ...
     * @internal
     */
    public function __construct(private Stmt $stmt, private readonly Context $context, private readonly Statements_Source $statements_source, private readonly Codebase $codebase, private array $file_replacements = [])
    {
    }
    ...
    public function set_stmt(Stmt $stmt): void
    {
        $this->stmt = $stmt;
    }
