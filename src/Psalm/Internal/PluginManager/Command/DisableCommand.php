 ...
 * @internal
 */
final class Disable_Command extends Command
{
    ...
    {
        $this->set_name('disable')->set_description('Disables a named plugin')->add_argument('pluginName', Input_Argument::REQUIRED, 'Plugin name (fully qualified class name or composer package name)')->add_option('config', 'c', Input_Option::VALUE_REQUIRED, 'Path to Psalm config file')->add_usage('vendor/plugin-package-name [-c path/to/psalm.xml]');
